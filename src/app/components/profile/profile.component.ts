...
export class ProfileComponent implements OnInit {
  ...
  apiUrl = 'https://todoappbe-ev8e.onrender.com/api/todos/getuser'; // API endpoint to fetch user details
  delUrl= 'https://todoappbe-ev8e.onrender.com/api/todos/deleteuser'
